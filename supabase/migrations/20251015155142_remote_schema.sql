...
CREATE OR REPLACE FUNCTION "public"."get_discrimination_patterns"("p_location_id" "uuid" DEFAULT NULL::"uuid", "p_threshold" numeric DEFAULT 1.5) RETURNS TABLE("location_id" "uuid", "location_name" "text", "pattern_type" "text", "severity" "text", "affected_demographics" "text"[], "evidence" "jsonb", "recommendation" "text")
    LANGUAGE "sql"
    AS $$
...
ALTER FUNCTION "public"."get_discrimination_patterns"("p_location_id" "uuid", "p_threshold" numeric) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_nearby_reviews"("lat" double precision, "lng" double precision, "radius_meters" integer DEFAULT 10000, "review_limit" integer DEFAULT 10) RETURNS TABLE("id" "uuid", "user_id" "uuid", "location_id" "uuid", "title" "text", "content" "text", "safety_rating" numeric, "overall_rating" numeric, "created_at" timestamp with time zone, "location_name" "text", "location_address" "text", "location_latitude" double precision, "location_longitude" double precision, "distance_meters" double precision, "user_full_name" "text", "user_show_demographics" boolean, "user_race_ethnicity" "text"[], "user_gender" "text", "user_lgbtq_status" boolean, "user_disability_status" "text"[])
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_nearby_reviews"("lat" double precision, "lng" double precision, "radius_meters" integer, "review_limit" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_safety_insights"("user_lat" double precision DEFAULT NULL::double precision, "user_lng" double precision DEFAULT NULL::double precision, "radius_meters" integer DEFAULT 50000, "max_results" integer DEFAULT 5) RETURNS TABLE("insight_type" "text", "message" "text", "location_id" "uuid", "location_name" "text", "location_address" "text", "severity" "text", "created_at" timestamp with time zone, "change_value" numeric)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_safety_insights"("user_lat" double precision, "user_lng" double precision, "radius_meters" integer, "max_results" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_trending_locations"("days_window" integer DEFAULT 7, "max_results" integer DEFAULT 5) RETURNS TABLE("location_id" "uuid", "location_name" "text", "location_address" "text", "review_count_current" integer, "review_count_previous" integer, "trend_direction" "text", "trend_percentage" numeric)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_trending_locations"("days_window" integer, "max_results" integer) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."user_profiles" (
    ...
    "push_token" "text",
    "notification_preferences" "jsonb" DEFAULT '{"safety_alerts": true, "weekly_digest": false, "review_responses": true, "travel_reminders": false, "community_updates": true, "location_triggers": false, "route_safety_changes": true}'::"jsonb",
...
COMMENT ON COLUMN "public"."user_profiles"."notification_preferences" IS 'User notification preferences stored as JSON';
...
ALTER TABLE ONLY "public"."safety_scores"
    ADD CONSTRAINT "safety_scores_location_id_demographic_type_demographic_valu_key" UNIQUE NULLS NOT DISTINCT ("location_id", "demographic_type", "demographic_value");
...
CREATE POLICY "Admins can insert reviews as any user" ON "public"."reviews" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."user_profiles"
  WHERE (("user_profiles"."id" = "auth"."uid"()) AND ("user_profiles"."role" = 'admin'::"text")))));



CREATE POLICY "Admins can see all locations" ON "public"."locations" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."user_profiles"
  WHERE (("user_profiles"."id" = "auth"."uid"()) AND ("user_profiles"."role" = 'admin'::"text")))));



CREATE POLICY "Admins can see all reviews" ON "public"."reviews" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."user_profiles"
  WHERE (("user_profiles"."id" = "auth"."uid"()) AND ("user_profiles"."role" = 'admin'::"text")))));



CREATE POLICY "Admins can update any location" ON "public"."locations" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."user_profiles"
  WHERE (("user_profiles"."id" = "auth"."uid"()) AND ("user_profiles"."role" = 'admin'::"text")))));



CREATE POLICY "Admins can update any review" ON "public"."reviews" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."user_profiles"
  WHERE (("user_profiles"."id" = "auth"."uid"()) AND ("user_profiles"."role" = 'admin'::"text")))));
...
CREATE POLICY "ml_training_data readable by authenticated" ON "public"."ml_training_data" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "route_segments readable by all" ON "public"."route_segments" FOR SELECT USING (true);
...
GRANT ALL ON FUNCTION "public"."get_discrimination_patterns"("p_location_id" "uuid", "p_threshold" numeric) TO "anon";
GRANT ALL ON FUNCTION "public"."get_discrimination_patterns"("p_location_id" "uuid", "p_threshold" numeric) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_discrimination_patterns"("p_location_id" "uuid", "p_threshold" numeric) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_nearby_reviews"("lat" double precision, "lng" double precision, "radius_meters" integer, "review_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_nearby_reviews"("lat" double precision, "lng" double precision, "radius_meters" integer, "review_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_nearby_reviews"("lat" double precision, "lng" double precision, "radius_meters" integer, "review_limit" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_safety_insights"("user_lat" double precision, "user_lng" double precision, "radius_meters" integer, "max_results" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_safety_insights"("user_lat" double precision, "user_lng" double precision, "radius_meters" integer, "max_results" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_safety_insights"("user_lat" double precision, "user_lng" double precision, "radius_meters" integer, "max_results" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_trending_locations"("days_window" integer, "max_results" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_trending_locations"("days_window" integer, "max_results" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_trending_locations"("days_window" integer, "max_results" integer) TO "service_role";

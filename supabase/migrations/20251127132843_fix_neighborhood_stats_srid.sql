-- Fix SRID mismatch in get_neighborhood_stats_for_point
-- The point must have SRID 4326 to match boundary geometry
...
'Returns neighborhood statistics for a given coordinate point. Fixed SRID mismatch.';
...
CREATE OR REPLACE FUNCTION "public"."calculate_location_safety_scores"("p_location_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."calculate_location_safety_scores"("p_location_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."extract_ml_training_data"() RETURNS TABLE("user_id" "uuid", "location_id" "uuid", "user_race_ethnicity" "text"[], "user_gender" "text", "user_lgbtq_status" boolean, "user_religion" "text", "user_age_range" "text", "location_type" "text", "location_latitude" numeric, "location_longitude" numeric, "safety_rating" numeric, "comfort_rating" numeric, "overall_rating" numeric, "review_created_at" timestamp with time zone)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."extract_ml_training_data"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."find_similar_users"("target_user_id" "uuid", "similarity_threshold" numeric DEFAULT 0.6) RETURNS TABLE("similar_user_id" "uuid", "similarity_score" numeric, "shared_demographics" "text"[])
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."find_similar_users"("target_user_id" "uuid", "similarity_threshold" numeric) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_basic_ml_recommendations"("target_user_id" "uuid", "max_recommendations" integer DEFAULT 5) RETURNS TABLE("location_id" "uuid", "location_name" "text", "predicted_safety_score" numeric, "confidence_score" numeric, "similar_user_count" integer, "recommendation_reason" "text")
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_basic_ml_recommendations"("target_user_id" "uuid", "max_recommendations" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_heatmap_data"("center_lat" double precision, "center_lng" double precision, "radius_meters" integer DEFAULT 10000, "user_race_ethnicity" "text"[] DEFAULT NULL::"text"[], "user_gender" "text" DEFAULT NULL::"text", "user_lgbtq_status" boolean DEFAULT NULL::boolean, "user_disability_status" "text"[] DEFAULT NULL::"text"[], "user_religion" "text" DEFAULT NULL::"text", "user_age_range" "text" DEFAULT NULL::"text") RETURNS TABLE("latitude" double precision, "longitude" double precision, "safety_score" numeric, "review_count" integer, "heat_weight" numeric)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_heatmap_data"("center_lat" double precision, "center_lng" double precision, "radius_meters" integer, "user_race_ethnicity" "text"[], "user_gender" "text", "user_lgbtq_status" boolean, "user_disability_status" "text"[], "user_religion" "text", "user_age_range" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_location_with_coords"("location_id" "uuid") RETURNS TABLE("id" "uuid", "name" "text", "address" "text", "city" "text", "state_province" "text", "country" "text", "place_type" "text", "latitude" double precision, "longitude" double precision, "avg_safety_score" numeric, "avg_comfort_score" numeric, "avg_overall_score" numeric, "review_count" integer, "verified" boolean, "active" boolean, "created_at" timestamp with time zone, "updated_at" timestamp with time zone)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_location_with_coords"("location_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_ml_recommendations_for_user"("target_user_id" "uuid", "user_lat" numeric DEFAULT NULL::numeric, "user_lng" numeric DEFAULT NULL::numeric, "max_distance_meters" integer DEFAULT 50000) RETURNS TABLE("location_id" "uuid", "location_name" "text", "predicted_safety_score" numeric, "confidence_score" numeric, "similar_user_count" integer, "recommendation_reason" "text", "distance_meters" integer)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_ml_recommendations_for_user"("target_user_id" "uuid", "user_lat" numeric, "user_lng" numeric, "max_distance_meters" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_nearby_locations"("lat" double precision, "lng" double precision, "radius_meters" integer DEFAULT 5000) RETURNS TABLE("id" "uuid", "name" "text", "address" "text", "place_type" "text", "distance_meters" integer, "avg_safety_score" numeric, "latitude" double precision, "longitude" double precision)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_nearby_locations"("lat" double precision, "lng" double precision, "radius_meters" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_nearby_locations_for_user"("lat" double precision, "lng" double precision, "user_race_ethnicity" "text"[] DEFAULT NULL::"text"[], "user_gender" "text" DEFAULT NULL::"text", "user_lgbtq_status" boolean DEFAULT NULL::boolean, "radius_meters" integer DEFAULT 5000) RETURNS TABLE("id" "uuid", "name" "text", "address" "text", "place_type" "text", "distance_meters" integer, "avg_safety_score" numeric, "demographic_safety_score" numeric, "latitude" double precision, "longitude" double precision)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_nearby_locations_for_user"("lat" double precision, "lng" double precision, "user_race_ethnicity" "text"[], "user_gender" "text", "user_lgbtq_status" boolean, "radius_meters" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."search_locations_with_coords"("search_query" "text", "result_limit" integer DEFAULT 5) RETURNS TABLE("id" "uuid", "name" "text", "address" "text", "city" "text", "state_province" "text", "place_type" "text", "latitude" double precision, "longitude" double precision)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."search_locations_with_coords"("search_query" "text", "result_limit" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."test_demographic_patterns"() RETURNS TABLE("pattern_type" "text", "pattern_value" "text", "user_count" bigint, "avg_safety_rating" numeric, "sample_locations" "text"[])
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."test_demographic_patterns"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."test_extract_ml_data"() RETURNS TABLE("user_id" "uuid", "location_id" "uuid", "user_race_ethnicity" "text"[], "user_gender" "text", "user_lgbtq_status" boolean, "location_name" "text", "location_type" "text", "safety_rating" numeric, "overall_rating" numeric)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."test_extract_ml_data"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."trigger_calculate_safety_scores"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  -- Add logging
...
ALTER FUNCTION "public"."trigger_calculate_safety_scores"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."locations" (
    ...
    "place_type" "public"."place_type_enum" NOT NULL,
    "tags" "text"[],
...
CREATE TABLE IF NOT EXISTS "public"."reviews" (
    ...
    CONSTRAINT "reviews_accessibility_rating_check" CHECK ((("accessibility_rating" >= 1) AND ("accessibility_rating" <= 5))),
    CONSTRAINT "reviews_comfort_rating_check" CHECK ((("comfort_rating" >= 1) AND ("comfort_rating" <= 5))),
    ...
    CONSTRAINT "reviews_status_check" CHECK (("status" = ANY (ARRAY['active'::"text", 'flagged'::"text", 'hidden'::"text", 'deleted'::"text"]))),
    CONSTRAINT "reviews_visit_type_check" CHECK (("visit_type" = ANY (ARRAY['solo'::"text", 'couple'::"text", 'family'::"text", 'group'::"text", 'business'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."route_segments" (
    ...
    "end_point" "public"."geography"(Point,4326),
...
CREATE TABLE IF NOT EXISTS "public"."safety_scores" (
    ...
    CONSTRAINT "safety_scores_avg_comfort_score_check" CHECK ((("avg_comfort_score" >= (1)::numeric) AND ("avg_comfort_score" <= (5)::numeric))),
    CONSTRAINT "safety_scores_avg_overall_score_check" CHECK ((("avg_overall_score" >= (1)::numeric) AND ("avg_overall_score" <= (5)::numeric))),
    CONSTRAINT "safety_scores_avg_safety_score_check" CHECK ((("avg_safety_score" >= (1)::numeric) AND ("avg_safety_score" <= (5)::numeric))),
    CONSTRAINT "safety_scores_demographic_type_check" CHECK (("demographic_type" = ANY (ARRAY['race_ethnicity'::"text", 'gender'::"text", 'lgbtq'::"text", 'disability'::"text", 'religion'::"text", 'age'::"text", 'overall'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."user_profiles" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "user_profiles_privacy_level_check" CHECK (("privacy_level" = ANY (ARRAY['public'::"text", 'anonymous'::"text", 'private'::"text"])))
);
...
ALTER TABLE ONLY "public"."safety_scores"
    ADD CONSTRAINT "safety_scores_location_id_demographic_type_demographic_valu_key" UNIQUE ("location_id", "demographic_type", "demographic_value");
...
CREATE OR REPLACE TRIGGER "auto_calculate_safety_scores" AFTER INSERT OR UPDATE ON "public"."reviews" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_calculate_safety_scores"();
...
ALTER TABLE ONLY "public"."ml_training_data"
    ADD CONSTRAINT "ml_training_data_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id");
...
ALTER TABLE ONLY "public"."safety_scores"
    ADD CONSTRAINT "safety_scores_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id") ON DELETE CASCADE;
...
CREATE POLICY "Active reviews are viewable by everyone" ON "public"."reviews" FOR SELECT USING (("status" = 'active'::"text"));



CREATE POLICY "Allow safety score calculation" ON "public"."safety_scores" FOR INSERT TO "authenticated", "anon" WITH CHECK (true);



CREATE POLICY "Allow safety score updates" ON "public"."safety_scores" FOR UPDATE TO "authenticated", "anon" USING (true) WITH CHECK (true);
...
CREATE POLICY "Locations are viewable by everyone" ON "public"."locations" FOR SELECT USING (("active" = true));
...
CREATE POLICY "Safety scores are viewable by everyone" ON "public"."safety_scores" FOR SELECT USING (true);



CREATE POLICY "Users can change their own votes" ON "public"."review_votes" FOR UPDATE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can delete their own votes" ON "public"."review_votes" FOR DELETE USING (("auth"."uid"() = "user_id"));
...
GRANT ALL ON FUNCTION "public"."calculate_location_safety_scores"("p_location_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_location_safety_scores"("p_location_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_location_safety_scores"("p_location_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."extract_ml_training_data"() TO "anon";
GRANT ALL ON FUNCTION "public"."extract_ml_training_data"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."extract_ml_training_data"() TO "service_role";



GRANT ALL ON FUNCTION "public"."find_similar_users"("target_user_id" "uuid", "similarity_threshold" numeric) TO "anon";
GRANT ALL ON FUNCTION "public"."find_similar_users"("target_user_id" "uuid", "similarity_threshold" numeric) TO "authenticated";
GRANT ALL ON FUNCTION "public"."find_similar_users"("target_user_id" "uuid", "similarity_threshold" numeric) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_basic_ml_recommendations"("target_user_id" "uuid", "max_recommendations" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_basic_ml_recommendations"("target_user_id" "uuid", "max_recommendations" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_basic_ml_recommendations"("target_user_id" "uuid", "max_recommendations" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_heatmap_data"("center_lat" double precision, "center_lng" double precision, "radius_meters" integer, "user_race_ethnicity" "text"[], "user_gender" "text", "user_lgbtq_status" boolean, "user_disability_status" "text"[], "user_religion" "text", "user_age_range" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_heatmap_data"("center_lat" double precision, "center_lng" double precision, "radius_meters" integer, "user_race_ethnicity" "text"[], "user_gender" "text", "user_lgbtq_status" boolean, "user_disability_status" "text"[], "user_religion" "text", "user_age_range" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_heatmap_data"("center_lat" double precision, "center_lng" double precision, "radius_meters" integer, "user_race_ethnicity" "text"[], "user_gender" "text", "user_lgbtq_status" boolean, "user_disability_status" "text"[], "user_religion" "text", "user_age_range" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_location_with_coords"("location_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_location_with_coords"("location_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_location_with_coords"("location_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_ml_recommendations_for_user"("target_user_id" "uuid", "user_lat" numeric, "user_lng" numeric, "max_distance_meters" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_ml_recommendations_for_user"("target_user_id" "uuid", "user_lat" numeric, "user_lng" numeric, "max_distance_meters" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_ml_recommendations_for_user"("target_user_id" "uuid", "user_lat" numeric, "user_lng" numeric, "max_distance_meters" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_nearby_locations"("lat" double precision, "lng" double precision, "radius_meters" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_nearby_locations"("lat" double precision, "lng" double precision, "radius_meters" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_nearby_locations"("lat" double precision, "lng" double precision, "radius_meters" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_nearby_locations_for_user"("lat" double precision, "lng" double precision, "user_race_ethnicity" "text"[], "user_gender" "text", "user_lgbtq_status" boolean, "radius_meters" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_nearby_locations_for_user"("lat" double precision, "lng" double precision, "user_race_ethnicity" "text"[], "user_gender" "text", "user_lgbtq_status" boolean, "radius_meters" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_nearby_locations_for_user"("lat" double precision, "lng" double precision, "user_race_ethnicity" "text"[], "user_gender" "text", "user_lgbtq_status" boolean, "radius_meters" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."search_locations_with_coords"("search_query" "text", "result_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."search_locations_with_coords"("search_query" "text", "result_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_locations_with_coords"("search_query" "text", "result_limit" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."test_demographic_patterns"() TO "anon";
GRANT ALL ON FUNCTION "public"."test_demographic_patterns"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."test_demographic_patterns"() TO "service_role";



GRANT ALL ON FUNCTION "public"."test_extract_ml_data"() TO "anon";
GRANT ALL ON FUNCTION "public"."test_extract_ml_data"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."test_extract_ml_data"() TO "service_role";



GRANT ALL ON FUNCTION "public"."trigger_calculate_safety_scores"() TO "anon";
GRANT ALL ON FUNCTION "public"."trigger_calculate_safety_scores"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trigger_calculate_safety_scores"() TO "service_role";
